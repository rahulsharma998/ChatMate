        ...
        {filteredUsers.map((user) => (
          <button
            ...
            className={`
              ...
              ${user.email === "ai@chatmate.com" ? "border-b border-base-200" : ""}
            `}
          >
              ...
              {(user.email === "ai@chatmate.com" || onlineUsers.includes(user._id)) && (
                <span
                  className={`absolute bottom-0 right-0 size-3 rounded-full ring-2 ring-zinc-900 ${
                    user.email === "ai@chatmate.com" ? "bg-purple-500" : "bg-green-500"
                  }`}
                />
              )}
            </div>
            ...
            <div className="hidden lg:block text-left min-w-0">
              <div className="font-medium truncate flex items-center gap-2">
                {user.fullName}
                {user.email === "ai@chatmate.com" && (
                  <span className="badge badge-xs badge-primary">AI</span>
                )}
              </div>
              <div className="text-sm text-zinc-400">
                {user.email === "ai@chatmate.com" ? "AI Assistant" : 
